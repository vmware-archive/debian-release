...
pushd ${GPDB_SRC_DIR}
    ...
    dch --create --package greenplum-database -v ${GPDB_VERSION_SHORT}  "${RELEASE_MESSAGE}"
    dch -r "ignored message"
popd
GPDB_VERSION_LONG=$(${GPDB_SRC_DIR}/getversion)

tar czf greenplum-database_${GPDB_VERSION_SHORT}.orig.tar.gz ${GPDB_SRC_DIR}
...
dput ${PPA_REPO} greenplum-database_${GPDB_VERSION_SHORT}_source.changes >/dev/null
